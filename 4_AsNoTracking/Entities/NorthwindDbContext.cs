...
public partial class NorthwindDbContext : DbContext
{
    ...
    public virtual DbSet<Parçalar> Parçalars { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer("Data Source=HASANHELVALI;Initial Catalog=NORTHWND; Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;" +
            "Application Intent=ReadWrite;Multi Subnet Failover=False").UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);
        //veya 
    ...
    //    optionsBuilder.UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);
        ...
        //Bu iki sekilde de kullanılabilir.
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Parçalar>(entity =>
        {
            entity.ToTable("Parçalar");

            entity.HasIndex(e => e.UrunId, "IX_Parçalar_UrunID");

            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.UrunId).HasColumnName("UrunID");

            entity.HasOne(d => d.Urun).WithMany(p => p.Parçalars).HasForeignKey(d => d.UrunId);
        });
