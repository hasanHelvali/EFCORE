...
//Default olarak EF Core log mesajlarında herhangi bir verinin değerini içermemektedir. Bunun nedeni, gizlilik teşkil edebilecek verilerin
//loglama sürecinde yanlışlıklada olsa açığa çıkmamasıdır. 
//Bazen alınan hatalarda verinin değerini bilmek hatayı debug edebilmek için oldukça yardımcı olabilmektedir. Bu durumda hassas verilerinde
//loglamasını sağlayabiliriz.
#endregion
...
class ApplicationDbContext : DbContext
{
    ...
    protected override async void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.LogTo(async message => await _log.WriteLineAsync(message), LogLevel.Information)//log leveli de ayarlanabilir.
            .EnableSensitiveDataLogging()//hassas loglama
            .EnableDetailedErrors();//hata loglama
        //optionsBuilder.LogTo(message => _log.WriteLine(message));
    }

    public override void Dispose()
    {
        //txt log dosyasını en son dispose ediyoruz.
        base.Dispose();
        _log.Dispose();
    }
