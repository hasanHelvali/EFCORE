...
//Kalıtımsal ilişkiye sahip olan entitylerin olduğu senaryolarda her bir hiyerarşiye(entity ye degil) karşılık bir tablo oluşturan davranıştır.
//Ayrıca bu davranıs normalizasyonda 3.normal forma aykırı bir durumdur. Normalizasyon mumkun oldugunca tabloları parcalamayı gerektirir.
//Ancak burada entity ler oratk bir tabloda birlestirilir.
#endregion
...
//Employee e1 = new() { Name = "A", Surname = "A", Department = "Yazılım Bilgi İşlem" };
//Employee e2 = new() { Name = "B", Surname = "B", Department = "Yazılım Bilgi İşlem" };
//Customer c1 = new() { Name = "C", Surname = "C", CompanyName = "Ahmet Bilmemne Halı Kilim Yıkama" };
//Customer c2 = new() { Name = "D", Surname = "D", CompanyName = "Şuayip Sucuk" };
//Technician t1 = new() { Name = "E", Surname = "E", Department = "Muhasebe", Branch = "Şöför" };
...
{
    public int A { get; set; }//A diye ayırır. Cunku hiyerarside 1.derinliktedir.
    public string? CompanyName { get; set; }
}
class Technician : Employee
{
    public int A { get; set; }//Technician_A seklinde ayrılır. CVunku hiyerarside 2 derinliktedir.
